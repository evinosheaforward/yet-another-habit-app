...
export const ONBOARDING_STEPS: OnboardingStep[] = [
  ...
  },
  {
    ...
    title: 'Pick a Date',
    description: 'Tap a future day to add habits or tasks to your todo for that specific date.',
    position: 'below',
    interactive: true,
  },
  {
    id: 'schedule-calendar-add',
    section: 'schedule',
    sectionTitle: 'Todo Schedule',
    screen: '/todo-settings',
    targetKey: 'calendar-add-btn',
    title: 'Schedule by Date',
    description: 'Add a habit or tasks to your todo for a specific day.',
    position: 'below',
  },
  ...
  },
  {
    ...
    sectionTitle: 'Archive',
    screen: '/(tabs)/archive',
    targetKey: 'archive-unarchive-btn',
    title: 'Unarchive',
    description:
      'Tap Unarchive to restore an activity back to your active list. Its history will be preserved.',
    position: 'below',
    hookTrigger: 'first-archive',
  },
  {
    ...
    sectionTitle: 'Archive',
    screen: '/(tabs)/archive',
    targetKey: 'archive-delete-btn',
    title: 'Permanent Delete',
    description:
      'Tap Delete to permanently remove an activity and all its history. This cannot be undone.',
    position: 'above',
    hookTrigger: 'first-archive',
  },
  {
    ...
    screen: '/(tabs)/activities',
    targetKey: 'new-habit-item',
    title: 'Your New Habit',
    description: 'Tap on your new habit to expand it and see more options.',
    position: 'below',
    interactive: true,
  ...
  },
  {
    ...
    sectionTitle: 'Tracking Progress',
    screen: '/(tabs)/activities',
    targetKey: 'new-habit-complete-btn',
    title: 'Track Progress',
    description: 'Tap Complete to increment your count toward the goal.',
    position: 'below',
    hookTrigger: 'first-habit-created',
  },
  {
    ...
    sectionTitle: 'Tracking Progress',
    screen: '/(tabs)/activities',
    targetKey: 'new-habit-details-btn',
    title: 'View Details',
    description: "Tap Details to view your habit's progress and history.",
    position: 'below',
    interactive: true,
    hookTrigger: 'first-habit-created',
  },
  {
    id: 'activity-detail-intro',
    section: 'history',
    sectionTitle: 'Tracking Progress',
    screen: '/activity/[id]',
    targetKey: 'activity-detail-header',
    title: 'Activity Details',
    description:
      'This page lets you view your history, adjust your goal count, and change settings for this habit.',
    position: 'below',
    hookTrigger: 'first-habit-created',
  },
  {
    ...
    sectionTitle: 'Tracking Progress',
    screen: '/activity/[id]',
    targetKey: 'activity-settings-header',
    title: 'Settings',
    description:
      'Scroll down to adjust your title, description, goal count, and habit stacking from here.',
    position: 'below',
    hookTrigger: 'first-habit-created',
  },
  {
    ...
    sectionTitle: 'Tracking Progress',
    screen: '/activity/[id]',
    targetKey: 'activity-archive-btn',
    title: 'Archive',
    description:
      'Archiving hides an activity from your main list but keeps all its history intact. You can unarchive it later from the Archive tab.',
    position: 'above',
    hookTrigger: 'first-habit-created',
  },
  {
